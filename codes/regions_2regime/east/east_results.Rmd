...
ct_spdata_long$lagtrev = splag(x = ct_spdata_long$trev, n = 86, t = 9, w = matrix6nn)
```
...
# important!!
#identical(ct_spdata_wide$城市shapefile,(as.character(tlaged_ct_spdata_long$城市shapefile))[1:86])

# 
#tlaged_ct_spdata_long %>%
#        as.data.frame() %>%
#        select(!geometry) %>%
#      xlsx::write.xlsx2("/Users/jialiangchen/Documents/spmodeltoruism/codes/regions_2regime/east/tlaged_east_spdata_long.xlsx")
#  
