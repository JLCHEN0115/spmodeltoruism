...
ct_spdata_long$lag2tarl = splag(x = ct_spdata_long$lagtarl, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2GDPpc = splag(x = ct_spdata_long$lagGDPpc, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2slry = splag(x = ct_spdata_long$lagslry, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2tarl = splag(x = ct_spdata_long$lagtarl, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2pop = splag(x = ct_spdata_long$lagpop, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2terti = splag(x = ct_spdata_long$lagterti, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2invest = splag(x = ct_spdata_long$laginvest, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2taxi = splag(x = ct_spdata_long$lagtaxi, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2hotel = splag(x = ct_spdata_long$laghotel, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2spot5A = splag(x = ct_spdata_long$lagspot5A, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2grnld = splag(x = ct_spdata_long$laggrnld, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2avexp = splag(x = ct_spdata_long$lagavexp, n = 86, t = 9, w = matrix6nn)
ct_spdata_long$lag2trev = splag(x = ct_spdata_long$lagtrev, n = 86, t = 9, w = matrix6nn)
```
