...
ct_spdata_long$lagtrev = splag(x = ct_spdata_long$trev, n = 80, t = 9, w = matrix6nn)
```
...
# important!!
#identical(ct_spdata_wide$城市shapefile,(as.character(tlaged_ct_spdata_long$城市shapefile))[1:80])
