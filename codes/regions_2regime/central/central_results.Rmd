...
library(xlsx)
 ...
 xlsx::write.xlsx2("/Users/jialiangchen/Documents/spmodeltoruism/codes/regions_2regime/central/central_tlaged_logged_ct_spdata_long.xlsx")
 
 ## output weight matrix (4nn)
 matrix4nn %>% as.data.frame() %>% write.xlsx2("/Users/jialiangchen/Documents/spmodeltoruism/codes/regions_2regime/central/central4nnmatrix.xlsx")
```
...
#   select(!geometry) %>%
#   arrange(year, 城市shapefile)  %>%
# write.xlsx2("/Users/jialiangchen/Documents/spmodeltoruism/codes/regions_2regime/east/tlaged_logged_ct_spdata_long.xlsx")
# 
# ## output weight matrix (4nn as an example)
# matrix4nn %>% as.data.frame() %>% write.xlsx2("/Users/jialiangchen/Documents/spmodeltoruism/codes/regions_2regime/east/east4nnmatrix.xlsx")
```
