...
ct_spdata_long$lagtarl = splag(x = ct_spdata_long$tarl, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lagGDPpc = splag(x = ct_spdata_long$GDPpc, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lagslry = splag(x = ct_spdata_long$slry, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lagtarl = splag(x = ct_spdata_long$tarl, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lagpop = splag(x = ct_spdata_long$pop, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lagterti = splag(x = ct_spdata_long$terti, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$laginvest = splag(x = ct_spdata_long$invest, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lagtaxi = splag(x = ct_spdata_long$taxi, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$laghotel = splag(x = ct_spdata_long$hotel, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lagspot5A = splag(x = ct_spdata_long$spot5A, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$laggrnld = splag(x = ct_spdata_long$grnld, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lagavexp = splag(x = ct_spdata_long$tavexp, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lagtrev = splag(x = ct_spdata_long$trev, n = 32, t = 9, w = matrix4nn)

ct_spdata_long$lag2tarl = splag(x = ct_spdata_long$lagtarl, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2GDPpc = splag(x = ct_spdata_long$lagGDPpc, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2slry = splag(x = ct_spdata_long$lagslry, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2tarl = splag(x = ct_spdata_long$lagtarl, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2pop = splag(x = ct_spdata_long$lagpop, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2terti = splag(x = ct_spdata_long$lagterti, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2invest = splag(x = ct_spdata_long$laginvest, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2taxi = splag(x = ct_spdata_long$lagtaxi, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2hotel = splag(x = ct_spdata_long$laghotel, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2spot5A = splag(x = ct_spdata_long$lagspot5A, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2grnld = splag(x = ct_spdata_long$laggrnld, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2avexp = splag(x = ct_spdata_long$lagavexp, n = 32, t = 9, w = matrix4nn)
ct_spdata_long$lag2trev = splag(x = ct_spdata_long$lagtrev, n = 32, t = 9, w = matrix4nn)
```
