...
for (i in 1:9){
  location_test[[i]] <-   identical(ct_spdata_wide$城市shapefile,(as.character(ct_spdata_long$城市shapefile))[(32*(i-1)+1):(32*i)])
}
...
#        as.data.frame() %>%
#        select(!geometry) %>%
#      xlsx::write.xlsx2("/Users/jialiangchen/Documents/spmodeltoruism/codes/regions_2regime/northeast/northeast_spdata_long.xlsx")
#  
