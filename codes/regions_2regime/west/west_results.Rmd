...
ct_spdata_long$Region_mean_dens <- numeric(765)

for (i in 1:9){
  ct_spdata_long$Region_mean_dens[(85*(i-1)+1):(85*i)] <- 
...
for (i in 1:9){
  location_test[[i]] <-   identical(ct_spdata_wide$城市shapefile,(as.character(ct_spdata_long$城市shapefile))[(85*(i-1)+1):(85*i)])
}
...
#        as.data.frame() %>%
#        select(!geometry) %>%
#      xlsx::write.xlsx2("/Users/jialiangchen/Documents/spmodeltoruism/codes/regions_2regime/west/west_spdata_long.xlsx")
#  
