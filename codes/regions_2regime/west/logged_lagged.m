...
% Read data
optsData = detectImportOptions('west_tlaged_logged_ct_spdata_long.xlsx');
preview('west_tlaged_logged_ct_spdata_long.xlsx',optsData);
optsData.SelectedVariableNames = [7:45];
A = readmatrix('west_tlaged_logged_ct_spdata_long.xlsx',optsData);
% Read weighting matrices
Wd200nb = readmatrix('westmatrixd200nb.xlsx','Range','B2:CH86');
