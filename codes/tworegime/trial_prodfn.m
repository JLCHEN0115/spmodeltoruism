...
% Read data
optsData = detectImportOptions('tlagy_prod_tlaged_ct_spdata_long.xlsx');
preview('tlagy_prod_tlaged_ct_spdata_long.xlsx',optsData);
optsData.SelectedVariableNames = [9:59];
A = readmatrix('tlagy_prod_tlaged_ct_spdata_long.xlsx',optsData);
