...
ct_spdata_long$lagtarl = splag(x = ct_spdata_long$tarl, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lagGDPpc = splag(x = ct_spdata_long$GDPpc, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lagslry = splag(x = ct_spdata_long$slry, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lagtarl = splag(x = ct_spdata_long$tarl, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lagpop = splag(x = ct_spdata_long$pop, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lagterti = splag(x = ct_spdata_long$terti, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$laginvest = splag(x = ct_spdata_long$invest, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lagtaxi = splag(x = ct_spdata_long$taxi, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$laghotel = splag(x = ct_spdata_long$hotel, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lagspot5A = splag(x = ct_spdata_long$spot5A, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$laggrnld = splag(x = ct_spdata_long$grnld, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lagavexp = splag(x = ct_spdata_long$tavexp, n = 283, t = 9, w = matrix3nn)
...
ct_spdata_long$lag2tarl = splag(x = ct_spdata_long$lagtarl, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2GDPpc = splag(x = ct_spdata_long$lagGDPpc, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2slry = splag(x = ct_spdata_long$lagslry, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2tarl = splag(x = ct_spdata_long$lagtarl, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2pop = splag(x = ct_spdata_long$lagpop, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2terti = splag(x = ct_spdata_long$lagterti, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2invest = splag(x = ct_spdata_long$laginvest, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2taxi = splag(x = ct_spdata_long$lagtaxi, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2hotel = splag(x = ct_spdata_long$laghotel, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2spot5A = splag(x = ct_spdata_long$lagspot5A, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2grnld = splag(x = ct_spdata_long$laggrnld, n = 283, t = 9, w = matrix3nn)
ct_spdata_long$lag2avexp = splag(x = ct_spdata_long$lagavexp, n = 283, t = 9, w = matrix3nn)
...
```{r}
first_stage <- plm(formula = neDtralgdp ~ lag2GDPpc + lag2slry + lag2pop + lag2terti + 
