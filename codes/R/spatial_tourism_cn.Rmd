...
pacman::p_load(sf, tidyverse, data.table, hrbrthemes, lwgeom, rnaturalearth, maps, mapdata, spData, tigris, tidycensus, leaflet, mapview, tmap, tmaptools, zoo)
## Download(if needed) and load other package for spatial regression.
pacman::p_load(pspatreg, spatialreg, spdep, sf, plm, splm, pspatreg)
