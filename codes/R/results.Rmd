...
3. **nosplag**:
```{r}
formula_nosplag <- trev ~ emphotel + invest + hotel + spot5A + lagemphotel + laginvest + laghotel + lagspot5A
```
...
```{r}
preg_nonspatial <- plm(formula, data = tlaged_logged_ct_spdata_long, index = c("indicator", "year"), model = "pooling")
