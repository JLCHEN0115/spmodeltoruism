...
resid_plot1 <- results %>% ggplot(aes(x=resid, y=tlaged_resid)) + geom_point() 
resid_plot2 <- results %>% ggplot(aes(x=resid, y=tlagedlaged_resid)) + geom_point()     
resid_plot3 <- results %>% ggplot(aes(x=resid, y=tlagedlagedlaged_resid)) + geom_point() 
